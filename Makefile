...
OBJECTS = ./kernel/kstart.o ./kernel.o ./console.o ./drivers/vga.o ./drivers/uart.o ./drivers/keyboard.o \
	./drivers/graphics.o ./drivers/mode13fb.o ./drivers/speaker.o \
...
user/snake: user/snake.o user/snake_game/snake_input.o user/snake_game/snake_model.o user/snake_game/snake_render.o user/snake_game/snake_runtime.o user/lib/gfx.o user/crt.o
	$(LD) $(LDFLAGS) -o $@ -Ttext 0x401000 $^
