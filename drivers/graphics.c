...
Borrowed every bit from https://github.com/sam46/xv6/blob/master/vga.c, which
...
setting the registers: much easier than writing down the values in 6-bit form!
*/
...
you change modes, so we have to keep one here to restore when we switch back to text mode.
*/
